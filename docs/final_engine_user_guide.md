...
- **Le handicap asiatique (AH) n'apporte pas d'information incrementale
  demontree** par rapport au modele recalibre : teste et infirme (Phase
  H, `docs/ah_incremental_information_experiment.md`) - l'essentiel du
  gain apparent provenait d'une simple recalibration, jamais du marche AH
