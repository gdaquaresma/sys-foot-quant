...
| `football_model` (Poisson simple, attaque/defense, A1, A2, benchmarks naif/Elo, B2 bayesien sequentiel, controles negatifs E1/E7) | Implemente (A1 reste INDETERMINE ; B2 VALIDE contre A1 sur synthetique, voir rapport etape 5 ; B1/B3 non implementes, voir docs/research_framework.md) | 2 (base) / 5 (B2, E1, E7) |
